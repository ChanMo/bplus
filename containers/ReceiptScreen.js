...
import {AsyncStorage, ToastAndroid,ImageBackground, Clipboard,TouchableOpacity,Alert, StatusBar,TextInput, View, Text, Button} from 'react-native'
  ...
  render() {
    ...
    return (
      <ImageBackground source={require('./../images/wallet-bg.png')} 
        ...
        <View style={{flex:1}}>
          <View style={{flex:1,margin:15,marginTop:50,marginBottom:50,borderRadius:5,backgroundColor:'#fff',alignItems:'center',justifyContent:'center'}}>
